        ...
        <div @click.away="open = false" class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-slate-100 md:w-64 dark:text-gray-200 dark:bg-gray-800" x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                ...
                <nav :class="{'block': open, 'hidden': !open}" 
                    ...
                    <x-admin-nav-link :href="route('admin.sports.index')" :active="request()->routeIs('admin.sports.index')">
                            {{ __('Sports') }}
                    </x-admin-nav-link>
                    <x-admin-nav-link :href="route('admin.slots.index')" :active="request()->routeIs('admin.slots.index')">
                            {{ __('Slots') }}
                    </x-admin-nav-link>
