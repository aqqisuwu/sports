  ...
  <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="flex m-2 p-2"> 
              <a href="{{route('admin.categories.index') }}" class="px-4 py-2 bg-indigo-500 hover:bg-indigo-700 rounded-lg text-white">Sport Index</a>
          </div>
              ...
              <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                  <form method="POST" action="{{ route('admin.sports.update', $sport->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="sm:col-span-6"> 
                      ...
                      <div class="mt-1">
                        <input type="text" id="name" name="name" value="{{ $sport->name }}"
                    ...
                    <div class="sm:col-span-6">
                      ...
                      <div>
                        <img class="w-32 h-32" src="{{ Storage::url($sport->image)}}">
                      </div>
                      <div class="mt-1">
